...
- Course duration: Monday, May 11th, 2020 - Friday, July 31st, 2020
- Holidays:
...
[Link to join the Zoom Room](https://generalassembly.zoom.us/j/92621959778?pwd=elRmSFVzVU95OC9oU21mbUJGVmw0dz09)
...
|:--         | :--             | :--         | :-- |
|Instructor | Jeremy Tupper | @jeremy | jeremy.tupper@generalassemb.ly |
|Instructor | Devon Noel DeTilly | @devonoel | devon.noel.de.tilly@generalassemb.ly |
...
2. In another tab, browse to the GA class repo:  [https://git.generalassemb.ly/sei-toronto/sei-4](https://git.generalassemb.ly/sei-toronto/sei-4)
...
```
$ git clone https://git.generalassemb.ly/YOUR-ENTERPRISE-GITHUB-USERNAME/sei-4
```

You can now `$ cd sei-4` and check out your local copy of of the GA class repo!
...
```
$ git remote add upstream https://git.generalassemb.ly/sei-toronto/sei-4.git
```
